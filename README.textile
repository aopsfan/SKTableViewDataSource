...
@dataSource = [[SKTableViewDataSource alloc] initWithSet:data target:self]@ lets your dataSource know a) what set of data to format for your tables, and b) where to access the "extra" UITableViewDataSource methods.
