...
@dataSource = [[SKTableViewDataSource alloc] initWithSet:data target:self]@ lets your dataSource know a) what set of data to format for your tables, and b) who to access extra @UITableViewDataSource@ methods from (that @SKTableViewDataSource@ can't implement) to "pass them on" to the table.
