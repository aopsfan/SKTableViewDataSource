...
@implementation SKTableViewDataSourceAdvancedAppAppDelegate
...
{
    SKAdvancedTestTableViewController *rootController = [[[SKAdvancedTestTableViewController alloc] initWithStyle:UITableViewStylePlain] autorelease];
